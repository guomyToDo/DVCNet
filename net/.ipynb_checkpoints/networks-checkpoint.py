...
from net.HRNet.hrnet_aspp_relu_cbn_v1 import HighResolutionNet as HRNet_aspp_relu_cbn_v1
from net.HRNet.hrnet_aspp_relu_cbn_v2 import HighResolutionNet as HRNet_aspp_relu_cbn_v2
...
def define_net(opt):
    ...
    if net_name == 'hrnet_relu':
        net = HRNet_relu()
        net.init_weights('hrnetv2_w40_imagenet_pretrained.pth')
    elif net_name == 'hrnet_aspp_relu': # s1
        net = HRNet_aspp_relu()
        net.init_weights('hrnetv2_w40_imagenet_pretrained.pth')
    elif net_name == 'hrnet_aspp_relu_cbn_v1':
        net = HRNet_aspp_relu_cbn_v1(opt.cls_num)
        net.init_weights('hrnetv2_w40_imagenet_pretrained.pth')
    elif net_name == 'hrnet_aspp_relu_cbn_v2':
        net = HRNet_aspp_relu_cbn_v2(opt.cls_num)
        net.init_weights('hrnetv2_w40_imagenet_pretrained.pth')
    elif net_name == 'res_unet_aspp':
        net = UNet(is_aspp=True,multi_head=opt.multi_head, drop_rate = opt.drop_rate)
    else:
